...
from app.chat_utils import get_chat_model, generate_response
    ...
    if uploaded_files:
        ...
        if st.button("🚀 Process Documents", type="primary"):
            with st.spinner("Processing your medical documents..."):
                ...
                # Initialize chat model (validate API key inside helper)
                try:
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                response = generate_response(st.session_state.chat_model, system_prompt)
